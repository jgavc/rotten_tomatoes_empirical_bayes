...
#Loading Data
modeling_data <- readRDS("data/mixed_beta_output.RData")
posterior_stats <- readRDS("data/posterior_stats.RData")
load("data/movie_df.RData")
mixed_beta_output <- readRDS("data/mixed_beta_output.RData")
critic_posterior_stats <- posterior_stats$critic_posterior_stats
mm_critic <- mixed_beta_output$mm_critic

#Loading Function
helper_functions <- readRDS("data/fit_mixed_beta_helpers.RData")
